...
int hypermaze_getmove (Pos *pos, int, int, GtkboardEventType, Player, byte **);
...
int hypermaze_getmove (Pos *pos, int x, int y, GtkboardEventType type, Player to_play, byte **movp)
{
	int curx = -1, cury = -1;
	int incx = -1, incy = -1;
